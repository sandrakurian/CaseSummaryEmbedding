...
7. [Prompts to Make Example Cases](#prompts-to-make-example-cases)
...
Below is the the general structure. fill in <>, do not include the Department of Families and Children in the response:
...
Given a case about an individual, write a new case about someone in a similar situation. Focus on creating a realistic scenario based on the provided case, ensuring the issues and context are similar but not identical.
